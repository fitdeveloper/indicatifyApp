...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './perimeter.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PERIMETER_LIST actions', async () => {
    ...
    it('dispatches FETCH_PERIMETER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PERIMETER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PERIMETER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PERIMETER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PERIMETER actions', async () => {
      const expectedActions = [
        {
