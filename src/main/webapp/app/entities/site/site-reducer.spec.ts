...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './site.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SITE_LIST actions', async () => {
    ...
    it('dispatches FETCH_SITE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SITE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SITE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SITE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SITE actions', async () => {
      const expectedActions = [
        {
