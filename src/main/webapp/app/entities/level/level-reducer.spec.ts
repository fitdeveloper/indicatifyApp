...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './level.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEVEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_LEVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_LEVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_LEVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_LEVEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_LEVEL actions', async () => {
      const expectedActions = [
        {
