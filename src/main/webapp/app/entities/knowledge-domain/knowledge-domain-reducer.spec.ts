...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_KNOWLEDGEDOMAIN_LIST actions', async () => {
    ...
    it('dispatches FETCH_KNOWLEDGEDOMAIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_KNOWLEDGEDOMAIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_KNOWLEDGEDOMAIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_KNOWLEDGEDOMAIN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_KNOWLEDGEDOMAIN actions', async () => {
      const expectedActions = [
        {
