...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("ma.indicatify.app.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("ma.indicatify.app.security.DomainUserDetailsService", "createSpringSecurityUser");
